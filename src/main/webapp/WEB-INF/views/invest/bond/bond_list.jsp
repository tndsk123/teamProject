...
<body>
	...
	<section class="container bond-comming-soon">
		<div class="subject">
			<h3>오픈예정 채권 프로젝트</h3>
		</div>
		<div class="row contents">
			<c:forEach var="row" items="${open_invest_list}">
			<div class="col-lg-3">
	...
	<section class="container hot-bond-project">
		<div>
			...
			<div class="row contents">
				<c:forEach var="row" items="${invest_list}">
				<div class="col-lg-3">
					<a href="${path}/fund/invest_detail/${row.bno}">
						<div class="row align-items-center">
							...
							<div class="col-lg-12 col-sm-8 col-12 summary">
								...
								<p><span class="company">${row.company_name}</span><span class="date">${row.now_date}일 남음</span></p>
							</div>
						</div>
					</a>
				</div>
